...
export default function DeliveryPage() {
  ...
  const { products, categories, getProductsByCategory, modifierGroups } = useProducts();
  ...
  const validate = () => {
    ...
    if (!customerInfo.address.trim() || customerInfo.address.length < 5) {
      newErrors.address = 'Dirección requerida (mínimo 5 caracteres)';
    }
    setErrors(newErrors);
  ...
  const handleSendOrder = async () => {
    ...
    const result = await createOrder('delivery', orderItems, {
      customerName: customerInfo.name,
      customerPhone: customerInfo.phone,
      customerAddress: customerInfo.address,
      addressReference: customerInfo.addressReference,
    });
      ...
      <div className="flex-1 flex flex-col min-h-0">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-bold">Domicilio</h1>
          </div>
        </div>
        ...
        <Card className="mb-4">
          <CardContent className="p-4 space-y-3">
            ...
            <Input
              ...
              onChange={(e) => setCustomerInfo({ addressReference: e.target.value })}
